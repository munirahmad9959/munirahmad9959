...
- **Full Stack Software Developer V2** — Coursera / IBM
- **Django Application Development with SQL and Databases** — Coursera / IBM
- **Writing Secure Code in ASP.NET** — Packt

---

<p align="center"><i>Always open to interesting problems</i></p>
